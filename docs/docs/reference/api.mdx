...
| Name            | Type                                                  | Required | Restrictions | Description                                                                                             |
| --------------- | ----------------------------------------------------- | -------- | ------------ | ------------------------------------------------------------------------------------------------------- |
| Args            | [PluginConfigArgs](#schemapluginconfigargs)           | true     | none         | PluginConfigArgs PluginConfigArgs PluginConfigArgs PluginConfigArgs PluginConfigArgs plugin config args |
...
_PluginConfigArgs PluginConfigArgs PluginConfigArgs PluginConfigArgs
PluginConfigArgs plugin config args_
...
_PluginDevice PluginDevice PluginDevice PluginDevice plugin device_
...
_PluginInterfaceType PluginInterfaceType PluginInterfaceType PluginInterfaceType
plugin interface type_
