...
| Name   | Type                                                        | Required | Restrictions | Description                                          |
| ------ | ----------------------------------------------------------- | -------- | ------------ | ---------------------------------------------------- |
| config | [settingsFlowMethodConfig](#schemasettingsflowmethodconfig) | true     | none         | SettingsFlowMethodConfig settings flow method config |
...
_SettingsFlowMethodConfig settings flow method config_
