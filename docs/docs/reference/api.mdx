...
_RegistrationFlow RegistrationFlow RegistrationFlow RegistrationFlow
registration flow_
...
| Name   | Type                                                        | Required | Restrictions | Description                                                                   |
| ------ | ----------------------------------------------------------- | -------- | ------------ | ----------------------------------------------------------------------------- |
| config | [settingsFlowMethodConfig](#schemasettingsflowmethodconfig) | true     | none         | SettingsFlowMethodConfig SettingsFlowMethodConfig settings flow method config |
...
_SettingsFlowMethodConfig SettingsFlowMethodConfig settings flow method config_
