...
| User            | [PluginConfigUser](#schemapluginconfiguser)           | false    | none         | PluginConfigUser PluginConfigUser plugin config user                                    |
...
_PluginConfigUser PluginConfigUser plugin config user_
