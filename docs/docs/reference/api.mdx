...
| Name          | Type                      | Required | Restrictions | Description                                                                                                                                                                                                                             |
| ------------- | ------------------------- | -------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| session       | [session](#schemasession) | true     | none         | Session Session Session Session session                                                                                                                                                                                                 |
...
| session       | [session](#schemasession)   | false    | none         | Session Session Session Session session                                                                                                                                                                                                                                                                                         |
...
_Session Session Session Session session_
...
| -------------------------- | ------------------------------------------------------- | -------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| active                     | string                                                  | false    | none         | Active, if set, contains the registration method that is being used. It is initially not set.                                                                                                  |
| expires_at                 | string(date-time)                                       | false    | none         | ExpiresAt is the time (UTC) when the request expires. If the user still wishes to verify the address, a new request has to be initiated. Format: date-time Format: date-time Format: date-time |
| id                         | [UUID](#schemauuid)                                     | false    | none         | none                                                                                                                                                                                           |
| issued_at                  | string(date-time)                                       | false    | none         | IssuedAt is the time (UTC) when the request occurred. Format: date-time Format: date-time Format: date-time                                                                                    |
| messages                   | [Messages](#schemamessages)                             | false    | none         | Messages Messages Messages Messages messages                                                                                                                                                   |
