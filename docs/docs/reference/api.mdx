...
| User            | [PluginConfigUser](#schemapluginconfiguser)           | false    | none         | PluginConfigUser PluginConfigUser PluginConfigUser plugin config user                                         |
...
_PluginConfigLinux PluginConfigLinux PluginConfigLinux plugin config linux_
...
_PluginConfigUser PluginConfigUser PluginConfigUser plugin config user_
...
_LoginFlow LoginFlow LoginFlow LoginFlow LoginFlow LoginFlow Login Flow_
...
| Name   | Type                                                        | Required | Restrictions | Description                                                                                                                     |
| ------ | ----------------------------------------------------------- | -------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| config | [settingsFlowMethodConfig](#schemasettingsflowmethodconfig) | true     | none         | SettingsFlowMethodConfig SettingsFlowMethodConfig SettingsFlowMethodConfig SettingsFlowMethodConfig settings flow method config |
