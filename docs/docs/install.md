...
```shell
$ docker pull oryd/kratos:v0.6.0-alpha.1.pre.1
...
```shell
$ bash <(curl https://raw.githubusercontent.com/ory/kratos/v0.6.0-alpha.1.pre.1/install.sh) -b . v0.6.0-alpha.1.pre.1
$ ./kratos help
```
