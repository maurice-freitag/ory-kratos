...
[`./contrib/quickstart/kratos`](https://github.com/ory/kratos/tree/v0.5.5-alpha.1/contrib/quickstart/kratos/email-password)
,
[`./quickstart.yml`](https://github.com/ory/kratos/blob/v0.5.5-alpha.1/quickstart.yml),
and
[`./quickstart-standalone.yml`](https://github.com/ory/kratos/blob/v0.5.5-alpha.1/quickstart-standalone.yml).
